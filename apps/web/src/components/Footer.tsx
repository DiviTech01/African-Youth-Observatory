  ...
  return (
    <footer className="bg-muted py-8 md:py-12 mt-12 md:mt-16">
      <div className="container px-4 md:px-6 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
        ...
        <div>
          <h3 className="font-medium mb-3 md:mb-4 text-sm md:text-base">Navigation</h3>
        ...
        <div>
          <h3 className="font-medium mb-3 md:mb-4 text-sm md:text-base">Resources</h3>
          <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
            <li>
              <a href="mailto:info@africanyouthstats.org" className="hover:text-foreground transition-colors break-all">
          ...
          <h3 className="font-medium mt-4 md:mt-6 mb-3 md:mb-4 text-sm md:text-base">Newsletter</h3>
      ...
      <div className="container px-4 md:px-6 mt-8 md:mt-12 pt-6 border-t border-muted-foreground/20">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
          <p className="text-center sm:text-left">© 2025 African Youth Statistics Database. All rights reserved.</p>
