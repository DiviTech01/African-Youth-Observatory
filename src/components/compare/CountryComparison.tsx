      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-1">
          <div className="border rounded-lg p-6 bg-card h-full">
            <h3 className="text-xl font-bold mb-6">Compare Countries</h3>
            
            <div className="space-y-6">
              <div className="space-y-2">
                <Label>Selected Countries ({selectedCountries.length}/5)</Label>
            ...
            <div className="chart-container border border-dashed rounded-md bg-background p-4 flex items-center justify-center">
              {selectedCountries.length === 0 || !selectedIndicator ? (
                ...
                <div className="w-full h-full">
                  {chartType === 'bar' ? (
                    <div className="w-full h-full flex items-end justify-around pt-10">
                      {selectedCountries.map((country, i) => (
                        <div key={country} className="flex flex-col items-center gap-2 group">
                          <div 
                            className={`w-12 bg-pan-${['green', 'blue', 'orange', 'purple', 'green'][i]}-500 hover:bg-pan-${['green', 'blue', 'orange', 'purple', 'green'][i]}-600 transition-all rounded-t-md`}
                            style={{ height: `${20 + Math.random() * 60}%` }}
                          ></div>
                          <span className="text-xs font-medium text-center max-w-[80px] truncate">{country}</span>
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <div className="relative w-[200px] h-[200px] bg-muted rounded-full flex items-center justify-center">
